...
const publicDocs = ["README.md", "WORKFLOW.md", "CLAUDE.md", "SECURITY.md",
  "docs/research-preview.md", "docs/research.md", "docs/evidence.md", "docs/licensing.md", "docs/semantic-memory.md"];
...
test("preview's installed demo and limitations are included without inventing a public repository", () => {
  for (const path of ["acceptance/installed_sg32_resources.mjs", "docs/research-preview.md", "docs/research.md", "docs/evidence.md", "SECURITY.md", "WORKFLOW.md"])
